...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="<?php echo  $this->config->base_url() ?>/assets/plugins/summernote/summernote-bs4.min.css">
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo  $this->config->base_url() ?>/assets/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
